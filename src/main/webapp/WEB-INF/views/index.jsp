					...
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<div class="input-group">
								<span class="input-group-btn"> </span> <label>Quantity</label><br>
								<input type="number" name="quant[1]" id="quantity"
									class="form-control input-number" value="1" min="1"> <br>
								<label>Zip Code</label> <input type="text" id="zipcode"
			...
			<div class="modal" id="wishListModal">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-danger" data-dismiss="modal"
								onclick="emptyModalWishList()">Close</button>
						</div>
